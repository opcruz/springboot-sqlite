...
class OrderControllerTest {
    ...
    void setUp() {
        ...
        UserAuthenticateInfo userAuthenticateInfoClient =
                UserAuthenticateInfo.builder()
                        .userId(clientUserId)
                        .subject("email@example")
                        .roles(List.of(Roles.CLIENT.getRoleWithPrefix()))
                        .build();
    ...
    void testOrderDetailsExistingOrder() {
        int orderId = 123;
        double total = 1500;
        OrderResultResponseDTO expectedResult =
                OrderResultResponseDTO.builder()
                        ...
                        .products(List.of())
                        .build();
        when(orderService.orderDetails(clientUserId, orderId)).thenReturn(Optional.of(expectedResult));
