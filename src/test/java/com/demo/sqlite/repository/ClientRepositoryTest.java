...
public class ClientRepositoryTest {
    ...
    public void testFindExistingClientByEmailAndPassword() {
        Optional<Client> clientFounded =
                clientRepository.findClientByEmailAndPassword(TEST_EMAIL, TEST_PASSWORD_HASH);
    ...
    public void testFindNonExistingClientByEmailAndPassword() {
        Optional<Client> clientFounded =
                clientRepository.findClientByEmailAndPassword(INVALID_EMAIL, INVALID_PASSWORD_HASH);
